<?php
    ...
    $totalData = mysqli_num_rows(mysqli_query($koneksi, "SELECT * FROM zainul WHERE $condition"));
                ...
                <div class="user-actions">
                    <div class="menu">
                        <ul>
                            ...
                            <li><a href="index.php">list Pembelian</a></li>
                        </ul>
                    </div>
                    <div class="user-auth">
        ...
        <div class="card">
            <div class="card-body">
                ...
                <table class="table table-bordered">
                    ...
                    <tbody>
                        <?php
                            $ambildata_perhalaman = mysqli_query($koneksi, "SELECT * FROM zainul 
